    ...
    <>
      ...
      <div className="container py-5 relative">
        <div className="d-flex justify-content-between align-items-center mb-5">
          <h1 className="display-6 font-extrabold text-[#1f2937] mb-0">Children Management</h1>
          <button 
            onClick={() => setIsAdding(true)}
            className="btn btn-primary d-flex align-items-center gap-2 rounded-xl px-4 py-2"
          >
